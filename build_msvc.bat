...
set INCLUDES=/I dependencies\SDL2\include /I dependencies\GLEW\include /I dependencies\freetype\include /I dependencies\freetype\include\freetype
...
mkdir .dist\ 2>NUL
copy ded.exe .dist\
copy dependencies\SDL2\lib\x64\SDL2.dll .dist\
copy dependencies\freetype\lib\win64\freetype.dll .dist\freetype.dll
